...
uint32_t nn::hac::KernelInitialProcessHeader::getProcessCategory() const
{
	return mProcessCategory;
}

void nn::hac::KernelInitialProcessHeader::setProcessCategory(uint32_t cat)
{
...
const nn::hac::KernelCapabilityBinary& nn::hac::KernelInitialProcessHeader::getKernelCapabilities() const
{
	return mKernelCapabilities;
}

void nn::hac::KernelInitialProcessHeader::setKernelCapabilities(const KernelCapabilityBinary& kc)
{
